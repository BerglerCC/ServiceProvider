...
namespace Bergler.Common.ServiceProvider.Attributes
{
    [AttributeUsage(AttributeTargets.Class)]
    public class WindowsServiceConfigurationAttribute : Attribute
    {
        // Marks an IWindowsService with configuration and installation attributes.
        public WindowsServiceConfigurationAttribute(string name)
        {
